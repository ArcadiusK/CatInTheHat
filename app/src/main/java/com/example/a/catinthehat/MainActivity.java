    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSally.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                // Do something in response to button click
                Context context = getApplicationContext();
                Toast toast = Toast.makeText(context, getString(R.string.buttonSallyText), Toast.LENGTH_SHORT);
                toast.show();
            }
        });
        ...
        buttonDrSeuss.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                // Do something in response to button click
                Context context = getApplicationContext();
                Toast toast = Toast.makeText(context, getString(R.string.buttonDrSeussText), Toast.LENGTH_SHORT);
                toast.show();
            }
        });
