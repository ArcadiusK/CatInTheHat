    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonTheCat.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Toast toast = Toast.makeText(context, getString(R.string.buttonTheCatText), Toast.LENGTH_LONG);
                toast.show();
            }
        });
        ...
        buttonThing1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                // Do something in response to button click
                Context context = getApplicationContext();
                Toast toast = Toast.makeText(context, getString(R.string.buttonThing1Text), Toast.LENGTH_LONG);
                toast.show();
            }
        });
        ...
        buttonThing2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                // Do something in response to button click
                Context context = getApplicationContext();
                Toast toast = Toast.makeText(context, getString(R.string.buttonThing2Text), Toast.LENGTH_SHORT);
                toast.show();
            }
        });
        ...
        buttonNick.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                // Do something in response to button click
                Context context = getApplicationContext();
                Toast toast = Toast.makeText(context, getString(R.string.buttonNickText), Toast.LENGTH_LONG);
                toast.show();
            }
        });
